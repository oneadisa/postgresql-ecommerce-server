...
export const updateCampaignProfile= async (req, res, next) => {
  try {
    ...
    (campaignInfo.durationPledgedProfit /
      ...
      const updatedCampaign = await updateCampaignBy(campaignInfo, {id});
...
/**
           ...
           * @memberof CampaignController
           */
// export const updateMyCampaignProfile= async (req, res) => {
//   try {
// const campaign = await findCampaignBy({userId: req.user.id});
// const id = campaign.id;
// const newCampaign = await updateCampaignBy(req.body, {id});
// const campaignResponse = extractCampaignData(newCampaign);
// successResponse(res, campaignResponse, 200);
//   } catch (error) {
// errorResponse(res, {code: error.statusCode, message: error.message});
//   }
...
/**
            ...
            * @memberof CampaignController
            */
// export const deleteMyCampaignAccount = async (req, res) => {
//   try {
// const campaign = await findCampaignBy({userId: req.user.id});
...
/**
           ...
           * @memberof Auth
           */
// export const getMyStoreCampaignDetails = async (req, res, next) => {
//   try {
// const campaigns = await findCampaignsBy({ownerId: req.user.id});
// if (!campaigns) {
//   return errorResponse(res, {code: 401, message:
// eslint-disable-next-line max-len
...
/**
           *
           *  Get single user profile campaign details
           * @static
           * @param {Request} req - The request from the endpoint.
           * @param {Response} res - The response returned by the method.
           * @param {Response} next - The response returned by the method.
           * @memberof Auth
           */
// export const getSingleStoreCampaignDetails = async (req, res, next) => {
//   try {
// const campaigns = await findCampaignsBy({ownerId: req.params.ownerId});
// if (!campaigns) {
//   return errorResponse(res, {code: 401, message:
//   eslint-disable-next-line max-len
